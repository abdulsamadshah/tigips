...
import 'package:tigips/Uploaddata/uploadarticles.dart';
                    ...
                    children: [
                          ...
                          ontap: () async {
                            ...
                            try {
                              ...
                              postRef
                                  ...
                                  .set({
                                "Pid": date.toString(),
                                "newimage": newUrl.toString(),
                                "newtitle": titlecontraoller.text.toString(),
                                "newdescription": desccontraoller.text
                                    .toString(),
                              }).then((value) {
                                Utils().statusmessage(
                      ...
                      Padding(
                        ...
                        child: Center(child: InkWell(
                          onTap: (){
                            Navigator.push(context, MaterialPageRoute(builder: (context) => uploadarticles(),));
                          },
                          child: Text("Upload Articles",
                            style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,fontFamily: "Medium"),),
                        )),

                      ),
                      Divider(color:Color(0XFF301934)),
                      // Roundbtn(title: "Upload Articles", ontap: () {
                      //   Navigator.push(context, MaterialPageRoute(builder: (context) => uploadarticles(),));
                      // })
                    ],
                  ),
