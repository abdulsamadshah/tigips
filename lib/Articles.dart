...
class Articles extends StatefulWidget {
  ...
  @override
  State<Articles> createState() => _MyHomePageState();
}

class _MyHomePageState extends State<Articles> {
                ...
                children: [
                  Expanded(
                    child: FirebaseAnimatedList(
                      query: dbRef.ref.child("articles"),
                                ...
                                Navigator.push(
                                    ...
                                    MaterialPageRoute(
                                      builder: (context) => NewsDetails(
                                          student['articleimage'],
                                          student["articletitle"],
                                          student["articledescription"]),
                                    ));
